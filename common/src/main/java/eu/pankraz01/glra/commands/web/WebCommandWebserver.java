...
public final class WebCommandWebserver {
    ...
    private static int start(CommandContext<CommandSourceStack> ctx) {
        GriefloggerRollbackAddon.StartResult result = GriefloggerRollbackAddon.startWebServerCommand(ctx.getSource().getServer());
        if (result.success()) {
    ...
    private static int stop(CommandContext<CommandSourceStack> ctx) {
        GriefloggerRollbackAddon.StopResult result = GriefloggerRollbackAddon.stopWebServerCommand();
        if (result.success()) {
